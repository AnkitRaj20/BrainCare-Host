        ...
        <div class="row g-5">
            <div class="col-lg-7">
                <div class="section-title mb-4">
                    ...
                    <h1 class="display-5 mb-0">The World's Best Mental Website That You Can Trust</h1>
                </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title mb-4">
                        <h5 class="position-relative d-inline-block text-primary text-uppercase">About Us</h5>
                        <h1 class="display-5 mb-0"> The best mental health online community to help each other </h1>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.3s">
                            ...
                            <h5 class="mb-3"><i class="fa fa-check-circle text-primary me-3"></i>Chat Room</h5>
                        </div>
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.6s">
                            <h5 class="mb-3"><i class="fa fa-check-circle text-primary me-3"></i>Inspiring Stories</h5>
                            <h5 class="mb-3"><h5i class="fa fa-check-circle text-primary me-3"></h5i>Online workshop</>
                            <h5 class="mb-3"><h5i class="fa fa-check-circle text-primary me-3"></h5i>Create Event</>


                        </div>
                    </div>
                    <a href="http://64.227.133.196/dashboard/dashboard/room.php?roomname=all" class="btn btn-primary py-3 px-5 mt-4 wow zoomIn" data-wow-delay="0.6s">Join Community</a>
                </div>
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="img/about2.jpeg" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
